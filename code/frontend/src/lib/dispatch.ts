...
export function useDispatch() {
  ...
  return { items, status, chips, sessionId, model, costUsd, started, attachedHistory, commands, commandUses, btw, noteSessionId, send, attach, decide, answer, interrupt, changeModel, reset, pushNote, seedHistory, askBtw, cancelBtw, markBtwMemory, clearBtwError };
}
